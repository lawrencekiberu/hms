...
public class doctors extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Doctor's details");
...
try{
    ...
    String sql  = "update doctors set doctor_name=?, father_name=?, address=?, contact_no=?, date_joining=? where doctor_id=?";
...
deletedoctors dtrs=new deletedoctors();
dtrs.setVisible(true);// TODO add your handling code here:
...
try{
    ...
    Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
Connection conn = DriverManager.getConnection(url,username,password);
String sql = "INSERT INTO doctors (doctor_id, doctor_name, father_name, address, contact_no, date_joining) VALUES (?,?,?,?,?,?)";
PreparedStatement PST = conn.prepareStatement(sql);
